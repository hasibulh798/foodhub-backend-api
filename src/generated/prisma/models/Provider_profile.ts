...
// @ts-nocheck 
/*
 * This file exports the `Provider_profile` model and its related types.
 *
...
export type GetProvider_profileAggregateType<T extends Provider_profileAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateProvider_profile[P]>
    : Prisma.GetScalarType<T[P], AggregateProvider_profile[P]>
}
...
type GetProvider_profileGroupByPayload<T extends Provider_profileGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Provider_profileGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Provider_profileGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Provider_profileGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Provider_profileGroupByOutputType[P]>
      }
    >
  >
...
export type Provider_profileCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface Provider_profileDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends Provider_profileCountArgs>(
    args?: Prisma.Subset<T, Provider_profileCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Provider_profileCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, Provider_profileGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProvider_profileGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
