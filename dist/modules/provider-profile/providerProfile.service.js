...
const createProvider = async (payload) => {
    const { name, email, password, phone, businessName, address, logoUrl, deliveryFee, } = payload;
...
// get single provider
const getSingleProvider = async (providerId) => {
...
const updateProviderProfile = async (payload, providerId) => {
